    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('active', 'active'), ('suspend', 'suspend'), ('ban', 'ban')], default='active', max_length=50, null=True)),
                ...
                ('willing_to_adopt', models.CharField(default='no', max_length=50)),
